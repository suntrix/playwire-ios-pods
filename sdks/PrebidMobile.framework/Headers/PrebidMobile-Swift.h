...
typedef SWIFT_ENUM(NSInteger, IMAAdSlotSize, closed) {
...
typedef SWIFT_ENUM(NSInteger, LogLevel_, closed) {
  LogLevel_Debug = 0,
  LogLevel_Verbose = 1,
  LogLevel_Info = 2,
  LogLevel_Warn = 3,
...
SWIFT_CLASS("_TtC12PrebidMobile9Swizzling")
@interface Swizzling : NSObject
+ (void)exchangeClassWithCls1:(Class _Nonnull)cls1 sel1:(SEL _Nonnull)sel1 cls2:(Class _Nonnull)cls2 sel2:(SEL _Nonnull)sel2;
+ (void)exchangeInstanceWithCls1:(Class _Nonnull)cls1 sel1:(SEL _Nonnull)sel1 cls2:(Class _Nonnull)cls2 sel2:(SEL _Nonnull)sel2;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
